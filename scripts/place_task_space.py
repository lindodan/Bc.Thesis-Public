#!/usr/bin/env python3 # Added shebang
...
if __name__ == '__main__':
    ...
    collision_box_name = "my_workspace_table"
    box_dimensions = (0.45, 0.6, 0.35)
    box_center_position = (0.605, 0.0, 0.20) # This is the position we will set

    box_dimensions = (0.35, 0.6, 0.35)
    box_center_position = (0.555, 0.0, 0.20) # This is the position we will set
    ...
    marker = Marker()
    marker.header.frame_id = "world" # Or use MoveGroupArm.get_planning_frame() if you need it relative to that
    marker.header.stamp = rospy.Time.now()
    marker.ns = "task_space_box_small"
    marker.id = 1
    ...
    marker.pose.position.z = box_center_position[2]
    ...
    # --- Set Color (Using your original values) ---
